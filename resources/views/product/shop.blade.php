...
<div class="bg-[#222] py-35 px-20">
    <div class="font-anek tracking-[0.2em] font-bold text-[25px] pb-25 m-auto max-w-[1440px] text-white">ALL</div>
    <div class="m-auto max-w-[1440px] flex justify-between">
        ...
        <div class="bg-black w-full lg:w-[80%] max-w-[1440px] flex justify-center flex-wrap">
