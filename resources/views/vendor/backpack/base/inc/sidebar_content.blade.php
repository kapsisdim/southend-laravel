...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('front-page') }}"><i class="la la-link"></i></i> Fornt Page</a></li>
...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('about') }}"><i class="la la-tag"></i></i> About Page</a></li>
