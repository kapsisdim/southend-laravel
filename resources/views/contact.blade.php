...
<div class="bg-[#222] py-35 px-20 md:h-[70vh]">
    <div class="font-anek tracking-[0.2em] font-bold text-[25px] pb-25 m-auto container text-white">CONTACT FORM</div>
    ...
    <div class="flex gap-20 flex-col lg:flex-row container mx-auto">
        <div class="bg-black lg:w-1/2 w-full text-white flex items-center justify-center container">
            <h3 class="p-20 font-anek tracking-wider leading-snug">While we’re good with smoke signals, there are simpler ways for us to get in touch and answer your questions.</h3>
        </div>
